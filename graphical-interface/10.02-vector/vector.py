...
Proszę dodać do klasy _Vector_ metodę ___bool\___, sprawdzającą, czy norma jest niezerowa. Jaki efekt ma dodanie tej metody? Sprawdź w dokumentacji! (https://docs.python.org/3/reference/datamodel.html#object.\__bool\__)                                                                                                                                                                                                                                                                                            class Vector:
